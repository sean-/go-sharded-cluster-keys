...
type Encoder interface {
	...
	// PrefixHexPad takes a uint64 prefix and pads the LSB to hex-aligned nibbles.
	PrefixHexPad(p uint64) uint64
...
func (e encoder) PrefixHexPad(prefix uint64) uint64 {
